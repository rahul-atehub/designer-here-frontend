...
export const API = {
  ...
  ACCOUNTS: {
    ...
    UNLINK: (userId) =>
      `${BASE_URL}${process.env.NEXT_PUBLIC_ACCOUNT_UNLINK_ENDPOINT}/${userId}`,
  },
  ...
  USER: {
    ...
    CHANGE_PASSWORD: `${BASE_URL}${process.env.NEXT_PUBLIC_CHANGE_PASSWORD_ENDPOINT}`, // to change the password .
    DELETE_ACCOUNT: `${BASE_URL}${process.env.NEXT_PUBLIC_AUTH_DELETE_ACCOUNT_ENDPOINT}`,
    DEACTIVATE_ACCOUNT: `${BASE_URL}${process.env.NEXT_PUBLIC_AUTH_DEACTIVATE_ACCOUNT_ENDPOINT}`,
